...
(function () {
    ...
    global.core = function (command) {
        ...
        if (arguments.length > 1 &&
            ...
            delete options[argsT[arguments.length - 1]];
...
(function () {
    ...
    renderer = global.renderer = {
        ...
        notifyRender: function (status) {
            ...
            if (!chartObj || (status.success === false)) {
...
(function () {
    ...
    window.__fusioncharts_dimension = (function () {
        ...
        return function (id) {
            var obj, parent;
            obj.__state.flashInvokedDimensionRequest = true;
...
(function () {
    ...
    // TODO: Optimize and compact conditional checks in this function.
    ...
    // module.
    loadModule = lib.loadModule = function (name, callback, failure, source) {
	    ...
	    // Check if loading has been blocked. If yes, then assume that
            // module exists.
                ...
                'required resources are absent and also blocked from loading.');
                failure && failure(metaKey);
                return;
            }
...
(function () {
    ...
    var xml2json = (function () {
        ...
        var rules = {
            ...
            arr: {
                ...
                // TODO: Annotation Group has to be implemented
            },
    ...
    var json2xml = (function () {
        ...
        return function (jsonData) {
            ...
            // Call JSON2XML parser to retrieve the parsed data.
            var rootNS = jsonData && jsonData.graph ?
                    'graph' : (jsonData && jsonData.map ? 'map' : 'chart'),
