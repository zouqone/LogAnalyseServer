...
import cn.log.app.user.dao.IUserDao;
import cn.log.app.user.vo.UserVo;
import cn.log.db.util.JdbcUtils;
import cn.log.tool.util.DBHelp;
import cn.log.app.user.util.IUserConstants;

/**
 * @author zouqone
 * @date 2014年5月28日 下午9:37:49
 */
public class UserDaoImpl implements IUserDao ,IUserConstants{

	
	/*=======================查询query===========================*/
	
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#queryAllUserVo()
	 * @return
	 */
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#queryUserVoByCondition(java.lang.String)
	 * @param condition
	 * @return
	 */
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#queryUserVoBySql(java.lang.String)
	 * @param sql
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#find(cn.log.app.user.vo.UserVo)
	 * @param userVo
	 * @return
	 */
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#insertUserVo(cn.log.app.user.vo.UserVo)
	 * @param userVo
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#insertUserVo(java.util.List)
	 * @param userVoList
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#updateUserVo(cn.log.app.user.vo.UserVo)
	 * @param userVo
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#updateUserVo(java.util.List)
	 * @param userVoList
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#deleteUserVo(cn.log.app.user.vo.UserVo)
	 * @param userVo
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#deleteUserVoByCondition(java.lang.String)
	 * @param condition
	 * @return
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.log.app.user.dao.IUserDao#queryUserVoTotalNumber()
	 * @return
	 */
	@Override
