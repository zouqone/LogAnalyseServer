...
public class ConfigVo {
	...
	/**
	 * @return the strutsxml
	 */
	public String getStrutsxml() {
		return strutsxml;
	}

	/**
	 * @param strutsxml the strutsxml to set
	 */
	...
	/**
	 * @param springxml the springxml to set
	 */
